...
final class LinkAI_AI_Customer_Service
{
    ...
    public static function render_shortcode(): string
    {
        ...
        ob_start();
        ?>
        <div class="linkai-chat <?php echo $reception_state['is_online'] ? '' : 'linkai-chat--offline'; ?> <?php echo $options['widget_position'] === 'left' ? 'linkai-chat--left' : ''; ?>" style="--linkai-primary: <?php echo esc_attr($options['widget_primary_color']); ?>;" data-welcome="<?php echo esc_attr($reception_state['message']); ?>">
            <button class="linkai-chat__toggle" type="button" aria-label="打开智能客服">
                <span class="linkai-chat__toggle-icon">AI</span>
                <span class="linkai-chat__toggle-text"><?php echo esc_html($options['widget_launcher_text']); ?></span>
            </button>
                ...
                <form class="linkai-chat__form">
                    <div class="linkai-chat__customer-fields">
                        ...
                        <?php if (count($departments) > 0) : ?>
                            <select class="linkai-chat__customer-input" name="department" aria-label="选择咨询部门">
    ...
    public static function enqueue_widget_assets(): void
    {
        ...
        wp_localize_script('linkai-ai-customer-service', 'LinkAICustomerService', [
            ...
            'widgetLauncherText' => $options['widget_launcher_text'],
            'widgetPrimaryColor' => $options['widget_primary_color'],
            'widgetPosition' => $options['widget_position'],
